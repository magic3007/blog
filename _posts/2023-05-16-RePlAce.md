...
| <img src="2023-05-16-RePlAce.assets/image-20230524150123752.png" alt="image-20230524150123752" style="zoom:50%;" /> | <img src="2023-05-16-RePlAce.assets/image-20230524150144943.png" alt="image-20230524150144943" style="zoom:50%;" /> |
| :-----------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------: |
...
<img src="2023-05-16-RePlAce.assets/image-20230524154114434.png" alt="image-20230524154114434" style="zoom:50%;" />
...
$$
\operatorname{Cost}_i=\frac{\partial W(\mathbf{v})}{\partial x_i}+\lambda \frac{\partial D^{\text {global }}(\mathbf{v})}{\partial x_i}+\textcolor{red}{\Delta_i} \frac{\partial D^{\text {local }}(\mathbf{v})}{\partial x_i}
$$
...
<img src="2023-05-16-RePlAce.assets/image-20230524160303346.png" alt="image-20230524160303346" style="zoom:50%;" />
...
<img src="2023-05-16-RePlAce.assets/image-20230524161513666.png" alt="image-20230524161513666" style="zoom:50%;" />
...
在这三个阶段中$min_{\text {cof}_{\max }}$和$\operatorname{cof}_{\text {range }}$单独设置。实验结果表明这种设置方式在之前的$\lambda$ scaling 方法的帕累托边界之外：

<img src="2023-05-16-RePlAce.assets/image-20230524162915804.png" alt="image-20230524162915804" style="zoom:50%;" />
...
<img src="2023-05-16-RePlAce.assets/image-20230524164219331.png" alt="image-20230524164219331" style="zoom:50%" />
...
<img src="2023-05-16-RePlAce.assets/image-20230524165039221.png" alt="image-20230524165039221" style="zoom:50%;" />
...
<img src="2023-05-16-RePlAce.assets/image-20230524170928362.png" alt="image-20230524170928362" style="zoom:50%;" />

### ISPD-2005, ISPD-2006 and MMS benchmarks

<img src="2023-05-16-RePlAce.assets/image-20230524171203627.png" alt="image-20230524171203627" style="zoom:50%;" />

### DAC-2012 benchmarks

<img src="2023-05-16-RePlAce.assets/image-20230524171220153.png" alt="image-20230524171220153" style="zoom:50%;" />

这里的实验结果表明，使用了 routability-driven detailed placer`NTUPlace4h`的`RePlAce-r alt`, 结果反而变差了。

### ICCAD-2012 benchmarks

<img src="2023-05-16-RePlAce.assets/image-20230524171232300.png" alt="image-20230524171232300" style="zoom:50%;" />
...
<img src="2023-05-16-RePlAce.assets/image-20230524171254353.png" alt="image-20230524171254353" style="zoom:50%;" />
